  ...
  <body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      else
      {
        ...
        [-a-z0-9+&@#\/%=~_|]/i",$web))   // seleksi kondisi pada var web
        {
      ...
      {
        $telp = cek_input($_POST["telp"]); // seleksi kondisi jika form kosong
      ...
      <div class="form-group row">
        ...
        <div class"form-group row">
          <div class="col-sm-10">
            ...
            <button type="submit" class="btn btn-primary">Sign In</buttons>
          </div>
        </div>
